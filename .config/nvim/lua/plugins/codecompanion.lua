-- https://github.com/olimorris/codecompanion.nvim/pull/934
local setup_mistral = function()
    ...
    return {
        ...
        schema = {
            ...
            temperature = {
                ...
                default = 0.2,
                desc =
                "What sampling temperature to use, between 0 and 0.7. Higher values like 0.8 will make the output more random, while lower values like 0.2 will make it more focused and deterministic. We generally recommend altering this or top_p but not both.",
                validate = function(n)
...
return {
    ...
    opts = {
        ...
        adapters = {
            openai = function()
                return require("codecompanion.adapters").extend("openai_compatible", setup_mistral())
            end,
        },
    },
    keys = {
